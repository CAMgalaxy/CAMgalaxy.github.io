/* add button: */
const downloadJSONButton = `<button class="material-icons" onclick="onDownloadCAMdata()" title="Save CAM as file" style="margin-right: 5px;">vertical_align_bottom</button>`;
