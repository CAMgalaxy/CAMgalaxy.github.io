...
class ConnectorCAM {
    ...
    draw(mother, daughter) {
        ...
        newRect.setAttribute("transform", `translate(${daughter.position.x},${daughter.position.y}) `)
        ...
        if (mother.isSelected || daughter.isSelected) {
            ...
            highlight.setAttribute("stroke", "#DED1C5");
        ...
        if (this.isSelected === true) {
            ...
            highlight.setAttribute("x2", (dist) * Math.cos(angle) * compensation);
            highlight.setAttribute("y2", (dist) * Math.sin(angle) * compensation);
            highlight.setAttribute("stroke", "#C8C5EB");
            highlight.setAttribute("stroke-width", 15);
            group.appendChild(highlight);
        }
